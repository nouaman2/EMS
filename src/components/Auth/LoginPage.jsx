...
const LoginPage = ({ isDarkMode, toggleTheme }) => {
  ...
  // Correct credentials
  const CORRECT_USERNAME = 'ctm01';
  const CORRECT_PASSWORD = 'ctm2018';
  ...
  const handleSubmit = (e) => {
    ...
    if (username === CORRECT_USERNAME && password === CORRECT_PASSWORD) {
      ...
      window.location.href = '/dashboard'; // This will force a page reload
    } else {
        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          <div className="form-group">
            ...
            <div className="password-input-container">
              ...
              <button type="button" className="password-toggle" onClick={togglePasswordVisibility} title={showPassword ? "Hide password" : "Show password"}>
                {showPassword ? (
